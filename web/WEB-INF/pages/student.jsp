                    ...
                    <div>
                        ...
                        <ul class="nav nav-tabs" role="tablist" id="myTabs">
                            <li role="presentation" class="active" onclick="foo(this)"><a href="#home"
                                    aria-controls="home" role="tab" data-toggle="tab">课题选择</a></li>
                            <li role="presentation" onclick="foo(this)"><a href="#result" onclick="addResult()"
                                    aria-controls="profile" role="tab" data-toggle="tab">成果上传</a></li>
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane" id="result"><br />
                                <div class="panel panel-default">
                                    ...
                                    <!-- Table -->
                                    <table class="table" id="projectSelected">
                                        <tr>
                                            <td style="width:60%">课题名称</td>
                                            <td style="width:20%">审核状态</td>
                                            <td style="width:20%">操作</td>
                                        </tr>
                                        <tr style="">
                                            <td style="width:60%">1</td>
                                            <td style="width:20%">审核中、、</td>
                                            <td style="width:20%">
                                                <a href="#">删除</a>
                                            </td>
                                        </tr>
